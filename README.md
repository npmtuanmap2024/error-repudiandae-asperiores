# @npmtuanmap2024/error-repudiandae-asperiores [![Build Status][build]](https://github.com/npmtuanmap2024/error-repudiandae-asperiores/actions?query=branch%3Amaster+workflow%3ACI) [![npm]](https://www.npmjs.com/package/@npmtuanmap2024/error-repudiandae-asperiores) [![mit]](https://opensource.org/licenses/MIT)

[build]: https://img.shields.io/github/actions/workflow/status/bcherny/@npmtuanmap2024/error-repudiandae-asperiores/ci.yml?style=flat-square
[npm]: https://img.shields.io/npm/v/@npmtuanmap2024/error-repudiandae-asperiores.svg?style=flat-square
[mit]: https://img.shields.io/npm/l/@npmtuanmap2024/error-repudiandae-asperiores.svg?style=flat-square
...
```sh
# Using Yarn:
yarn add @npmtuanmap2024/error-repudiandae-asperiores

# Or, using NPM:
npm install @npmtuanmap2024/error-repudiandae-asperiores --save
```

## Usage

```js
import { compile, compileFromFile } from '@npmtuanmap2024/error-repudiandae-asperiores'
...
See [server demo](example) and [browser demo](https://github.com/npmtuanmap2024/error-repudiandae-asperiores-browser) for full examples.
...
| bannerComment | string | `"/* eslint-disable */\n/**\n* This file was automatically generated by @npmtuanmap2024/error-repudiandae-asperiores.\n* DO NOT MODIFY IT BY HAND. Instead, modify the source JSONSchema file,\n* and run @npmtuanmap2024/error-repudiandae-asperiores to regenerate this file.\n*/"` | Disclaimer comment prepended to the top of each generated file |
...
- `tsType`: Overrides the type that's generated from the schema. Useful for forcing a type to `any` or when using non-standard JSON schema extensions ([eg](https://github.com/sokra/@npmtuanmap2024/error-repudiandae-asperiores/blob/f1f40307cf5efa328522bb1c9ae0b0d9e5f367aa/test/e2e/customType.ts)).
...
- [See more](https://github.com/npmtuanmap2024/error-repudiandae-asperiores/network/dependents?package_id=UGFja2FnZS0xNjUxOTM5Mg%3D%3D)
